...
var precacheConfig = [
        ["/index.html", "2143d1e2f9801e1d7074965668e63c7d"],
        ["/static/css/main.29266132.css", "291b7c703eff1eb45671bed973045228"],
        ["/static/js/main.149079b7.js", "44bfff9c98fb9e2bb47c4c301d5a6516"],
...
self.addEventListener("install", function(e) {
    ...
    if ("GET" === t.request.method) {
        ...
        var a = "/index.html";
        !e && "navigate" === t.request.mode && isPathWhitelisted(["^(?!\\/(__|auth)).*"], t.request.url) && (n = new URL(a, self.location).toString(), e = urlsToCacheKeys.has(n)), e && t.respondWith(caches.open(cacheName).then(function(e) {
